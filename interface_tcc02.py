...
class interface(Tk):
    ...
    def enviar_dados(self):
        ...
        for i in range(0,int(self.num_variaveis.get())+1):
        ...
        for i in range(0,int(self.num_variaveis.get())+1):
            ...
            if i == int(self.num_variaveis.get()):
        ...
        self.Pop = var_iniciais(dados_de_entrada, dados_de_saida, limites, self.dados_restricoes)
        ...
        arquivo_entrada = open("C:/Users/darve/Desktop/codigo_teste_TCC/respostas.txt", 'w')
        for i in range(0,len(dados_de_entrada)):
            arquivo_entrada.write(str(dados_de_entrada[i]))
            arquivo_entrada.write(",")
        arquivo_entrada.write("FO")
        arquivo_entrada.write(",")
        arquivo_entrada.write("res metamodelo")
        arquivo_entrada.write("\n")
        for i in range(inicio_neural, len(lista_entradas_rn)):
            for j in range(0, len(lista_entradas_rn[i])):
                arquivo_entrada.write(str(lista_entradas_rn[i][j]))
                arquivo_entrada.write(",")
            arquivo_entrada.write(str(resposta_meta[i-inicio_neural]))
            arquivo_entrada.write("\n")
    ...
    def tela_simulacao(self):
        ...
        self.menu_linguagens = OptionMenu(self.dados_simulacao,self.ling,"python","R")
        ...
        self.aplicar_endereco = Button(self.dados_simulacao, width = 20, text = "aplicar")
    ...
    def tela_variaveis(self):
        ...
        self.label_nome.grid(row=0,column = 2)
        self.label_max = Label(self.tabela_var ,text = "valor maximo")
        self.label_max.grid(row=0,column = 3)
        self.label_tipo = Label(self.tabela_var ,text = "tipo")
        self.label_tipo.grid(row=0,column = 4)
